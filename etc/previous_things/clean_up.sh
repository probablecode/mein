...
then
	...
	# delete some files from Application Support/Code/
	rm -rf ~/Library/Application Support/Code/User/workspaceStorage/*
	rm -rf ~/Library/Application Support/Code/CachedExtensionVSIXs/*
	echo "\033[1;33mFiles from Library/Application Support/Code deleted\033[0m"
	# delete some files from Application Support/Google/Chrome/
	rm -rf ~/Library/Application Support/Google/Chrome/Default/Service Worker/CacheStorage/*
	rm -rf ~/Library/Application Support/Google/Chrome/Default/optimization_guide_prediction_model_downloads/*
	echo "\033[1;33mFiles from Library/Application Support/Google/Chrome deleted\033[0m"
	df -h | grep 'Users' | awk ' { printf("\n>> Result : %s\n\n" , $5) }' 
