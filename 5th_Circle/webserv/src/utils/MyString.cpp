...
std::string MyString::ColorString(
    const std::string &str, enum StringColor foreground_color = kStrPreset,
    enum StringColor background_color = kStrPreset) {
...
std::string MyString::ColorString(
    const char *str, enum StringColor foreground_color = kStrPreset,
    enum StringColor background_color = kStrPreset) {
...
std::string MyString::GetFirstWord(const std::string &str,
                                   const char delimiter) {
  std::vector<std::string> tokens = MyString::Split(str, ' ');
  return tokens.front();
}